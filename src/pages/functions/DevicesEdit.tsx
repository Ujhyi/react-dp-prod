...
const ADD_NEW_DEVICE_URL = `${API_BASE_URL}/EditDevice`;
            ...
            <div className={`transition-all duration-300 ${ collapsed ? "ml-0" : "ml-34" } w-full`}>
                ...
                <div className={`transition-all duration-300 ${collapsed ? "ml-20" : "ml-64"} w-full`}>
                    ...
                    <header className="bg-gray-900 w-full h-20 fixed top-0 flex items-center shadow-lg px-8 z-10">
                        <h1 className="text-2xl font-bold text-white flex items-center"><i className="bi bi-pen mr-4"></i>Editing Devices</h1>
                    </header>
                    ...
                    <main className="flex justify-center items-start pt-28 bg-gray-100 min-h-screen">
                        <div className="bg-white shadow-lg rounded-lg p-10 max-w-5xl w-full">
                            ...
                            <form onSubmit={confirmAdd} className="space-y-6">
                                <h2 className="text-3xl font-bold text-gray-800 border-b pb-3">Edit Device</h2>
                                {/* Input Grid */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select name="displayTech" value={formData.displayTech} onChange={handleChange}  className="w-full p-3 border rounded-md shadow-sm focus:ring focus:ring-blue-300">
                                            <option value="" disabled>Select</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="maxResolutions" value={formData.maxResolutions} onChange={handleChange}  className="w-full p-3 border rounded-md shadow-sm focus:ring focus:ring-blue-300">
                                            <option value="" disabled>Select</option>
                    ...
                    {showConfirmation && (
                        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
                            <div className="bg-white p-6 rounded-lg shadow-xl w-96">
                                <h2 className="text-lg font-semibold mb-4 text-gray-900">Are you sure you want to edit this device?</h2>
